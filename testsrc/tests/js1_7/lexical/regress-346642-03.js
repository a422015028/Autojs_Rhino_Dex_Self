...
function test()
{
  ...
  expect = /TypeError: defpackage.t (has no properties|is undefined)/;
  actual = 'No Crash';
  try
  {
    z = [1];
  ...
  expect = 'TypeError: p.z = <defpackage><y/></defpackage> ? 3 : 4 is not a function';
  actual = 'No Crash';
  try
  {
    (new Function("if(\n({y:5, p: (print).r})) { p={}; (p.z = <defpackage\n><y/></defpackage> ? 3 : 4)(5) }"))();
  }
  catch(ex)
  {
    actual = ex + '';
