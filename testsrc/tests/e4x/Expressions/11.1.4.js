...
TEST(18, "<defpackage a=\"5 &lt; 3 is false\">5 &lt; 3 is false</defpackage>", x.toXMLString());

x = <{c} a={a + " > " + b + " is " + (a > b)}>{a + " > " + b + " is " + (a > b)}</{c}>;
TEST(19, "<defpackage a=\"5 > 3 is true\">5 &gt; 3 is true</defpackage>", x.toXMLString());
