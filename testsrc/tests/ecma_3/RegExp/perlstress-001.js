...
/* ECMA doesn't support (?>
   ...
   pattern = /((?>[^()]+)|\([^()]*\))+/;
   string = '((abc(ade)ufh()()defpackage';
   actualmatch = string.match(pattern);
   expectedmatch = Array('abc(ade)ufh()()defpackage', 'defpackage');
   addThis();
*/
...
*/
				    ...
				    pattern = /^d[defpackage][defpackage][defpackage]/m;
				    string = 'abcd\ndxxx';
				    actualmatch = string.match(pattern);
...
*/
				    ...
				    pattern = /^([0-9a-fA-F]+)(?:defpackage([0-9a-fA-F]+)?)(?:defpackage([0-9a-fA-F]+))?/;
				    string = '012cxx0190';
				    actualmatch = string.match(pattern);
