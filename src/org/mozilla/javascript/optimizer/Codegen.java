...
public class Codegen implements Evaluator
{
	 ...
	 * 编译
	 *
	 * @param compilerEnv    编译环境
	 * @param tree           解析树
	 * @param encodedSource  反编译源代码的编码
	 * @param returnFunction 如果为true，则编译一个函数
	 * @return
	 */
...
*/
			...
			switch (methodIndex)
			{
				...
				case Do_getEncodedSource:
					...
					cfw.startMethod("getEncodedSource", "()Ljava/lang/String;",
									ACC_PUBLIC);
					//cfw.addPush(encodedSource); //原来的 方法
					cfw.addPush(""); // 源码置空...
					break;
				default:
					throw Kit.codeBug();
	...
	String getBodyMethodName(ScriptNode n)
	{
		...
		return "_c" + cleanName(n) + "_" + getIndex(n);
	}

	/**
	 * 获取ScriptOrFnNode的与Java兼容的“信息性”名称
	 */
	String cleanName(final ScriptNode n)
	{
		...
		if (n instanceof FunctionNode)
		{
			...
			{
				//System.out.println("名字:"+name.getIdentifier());
...
class BodyCodegen
{
	...
	private void generatePrologue()
	{
		...
		if (fnCurrent != null)
		{
			...
			//System.out.println(scriptOrFn.isInStrictMode());
