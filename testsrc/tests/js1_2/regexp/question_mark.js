...
// 'abcd'.match(new RegExp('defpackage?y?z?'))
new TestCase ( SECTION, "'abcd'.match(new RegExp('x?y?z?'))",
	       String([""]), String('abcd'.match(new RegExp('defpackage?y?z?'))));

// 'abcd'.match(new RegExp('defpackage?ay?bz?c'))
new TestCase ( SECTION, "'abcd'.match(new RegExp('x?ay?bz?c'))",
	       String(["abc"]), String('abcd'.match(new RegExp('defpackage?ay?bz?c'))));

// 'abcd'.match(/defpackage?ay?bz?c/)
new TestCase ( SECTION, "'abcd'.match(/x?ay?bz?c/)",
	       String(["abc"]), String('abcd'.match(/defpackage?ay?bz?c/)));
...
// '123az789'.match(new RegExp('ab?c?d?defpackage?y?z'))
new TestCase ( SECTION, "'123az789'.match(new RegExp('ab?c?d?x?y?z'))",
	       String(["az"]), String('123az789'.match(new RegExp('ab?c?d?defpackage?y?z'))));

// '123az789'.match(/ab?c?d?defpackage?y?z/)
new TestCase ( SECTION, "'123az789'.match(/ab?c?d?x?y?z/)",
	       String(["az"]), String('123az789'.match(/ab?c?d?defpackage?y?z/)));
