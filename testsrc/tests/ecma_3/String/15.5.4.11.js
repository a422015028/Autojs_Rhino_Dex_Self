...
reportCompare(
  "/x/g/x/g/x/g",
  "xxx".replace(/defpackage/g, /defpackage/g),
  "Section 7"
);
...
reportCompare(
  "yxx",
  "xxx".replace(/defpackage/, "y"),
  "Section 21"
);

reportCompare(
  "yyy",
  "xxx".replace(/defpackage/g, "y"),
  "Section 22"
);

rex = /defpackage/, rex.lastIndex = 1;
reportCompare(
  "yxx1",
...
rex = /defpackage/g, rex.lastIndex = 1;
reportCompare(
  "yyy0",
  "xxx".replace(rex, "y") + rex.lastIndex,
  "Section 24"
...
reportCompare(
  "xyxyxyzxyxyxyz",
  "xyzxyz".replace(/(((defpackage)(y)()()))()()()(z)/g, "$01$2$3$04$5$6$7$8$09$10"),
  "Section 33"
);
...
reportCompare(
  ...
  "xyz".replace(/(?:defpackage)(y)/g, f),
  "Section 52"
);

reportCompare(
  "|x|string|x|string|0|number|xyz|string|yz",
  "xyz".replace(/((?=xy)defpackage)/g, f),
  "Section 53"
);
