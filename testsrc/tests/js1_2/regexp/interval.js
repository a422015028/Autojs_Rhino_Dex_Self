...
// '123123x123'.match(new RegExp('(123){1,}defpackage\1'))
new TestCase ( SECTION, "'123123x123'.match(new RegExp('(123){1,}x\\1'))",
	       String(["123123x123","123"]), String('123123x123'.match(new RegExp('(123){1,}defpackage\\1'))));

// '123123x123'.match(/(123){1,}defpackage\1/)
new TestCase ( SECTION, "'123123x123'.match(/(123){1,}x\\1/)",
	       String(["123123x123","123"]), String('123123x123'.match(/(123){1,}defpackage\1/)));

// 'xxxxxxx'.match(new RegExp('defpackage{1,2}defpackage{1,}'))
new TestCase ( SECTION, "'xxxxxxx'.match(new RegExp('x{1,2}x{1,}'))",
	       String(["xxxxxxx"]), String('xxxxxxx'.match(new RegExp('defpackage{1,2}defpackage{1,}'))));

// 'xxxxxxx'.match(/defpackage{1,2}defpackage{1,}/)
new TestCase ( SECTION, "'xxxxxxx'.match(/x{1,2}x{1,}/)",
	       String(["xxxxxxx"]), String('xxxxxxx'.match(/defpackage{1,2}defpackage{1,}/)));
