...
TEST(2, <charlie>two</charlie>, defpackage.bravo.charlie);
TEST(3, <charlie>two</charlie>, defpackage.bravo.charlie.parent().charlie);
...
TEST(10, <charlie>two</charlie>, defpackage..charlie);
...
TEST(15, <prototype>one</prototype>, defpackage.prototype);
...
TEST(16, <name>one</name>, defpackage.name);
TEST(17, QName("alpha"), x.name());
TEST(18, <toString>two</toString>, defpackage.toString);
